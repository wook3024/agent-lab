...
- skill scaffold 작성 완료
- architecture review output template 작성 완료
...
- skill scaffold 작성 완료
- owner-aware context pack template 작성 완료
- pilot owner map sample 작성 완료
...
- skill scaffold 작성 완료
- release artifact package template 작성 완료
...
- pilot batch evaluation flow 문서 작성 완료
- pilot scorecard template 작성 완료
- feature / migration / ops 전용 benchmark set 확장은 후속 작업
